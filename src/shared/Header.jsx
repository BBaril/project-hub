...
export default function Header() {
  ...
  return (
    <header className="w-full bg-bbOffWhite text-bbOffBlack dark:text-gray-200 dark:bg-gray-900">
      <div className="flex justify-between items-center px-1 py-1.5 mt-1 mb-1 max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-3 relative pr-0.5 w-48">
          ...
          <div className="relative" ref={menuRef}>
            ...
            {/* Dropdown menu */}
            {menuOpen && (
              <div className="absolute right-0 top-full mt-2 w-20 bg-bbOffWhite dark:bg-bbOffBlackSoft text-sm font-bold shadow-lg rounded-md z-50 p-2 space-y-2">
                <a
                  href="#client-work"
                  onClick={() => setMenuOpen(false)}
                  className="block hover:text-bbPinkDark hover:font-bold dark:hover:text-bbPinkDark hover:dark:font-bold font-semibold"
                >
                  Client
                </a>
                <a
                ...
                <a
                  href="#web-interface"
                  onClick={() => setMenuOpen(false)}
                  className="block hover:text-bbPinkDark hover:font-bold dark:hover:text-bbPinkDark dark:hover:font-bold font-semibold"
                >
                  Web
                </a>
                <a
