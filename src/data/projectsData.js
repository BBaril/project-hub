...
const projectsData = [
    {
      ...
      tags: ['JavaScript', 'HTML', 'CSS', 'JSON', 'Photoshop', 'Personal Project', 'Client Work', 'Website'],
      uxDetails: {
  ...
  
    {
      ...
      tags: ['Tkinter', 'Desktop GUI', 'Math', 'Personal Project'],
      target: 'My first GUI.',
...

    {
      ...
      tags: ['React', 'Tailwind', 'JavaScript', 'UI/UX', 'Personal Project'],
    ...
    
    {
      ...
      tags: ['Tkinter', 'Desktop GUI', 'Python', 'Personal Project'],
    ...
    
    {
      ...
      tags: ['Python', 'Terminal', 'Adventure Story', 'Creative', 'Personal Project'],
...

    {
      ...
      tags: ['React', 'Tailwind', 'Sound', 'Adventure Story', 'Creative', 'Personal Project'],
...

    {
      ...
      tags: ['React', 'Tailwind', 'UI/UX', 'Sound', 'Animation', 'Adventure Story', 'Creative', 'Personal Project'],
    ...
    
    {
      ...
      tags: ['Python', 'Tkinter', 'Desktop GUI', 'Math', 'Utilities',],
    ...
    
    {
      ...
      tags: ['HTML', 'CSS', 'JavaScript', 'Static', 'Personal Project'],
